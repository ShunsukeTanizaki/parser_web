  ...
  <section>
    ...
    <v-flex xs12>
      <v-container grid-list-xl fluid>
        <v-layout row wrap align-center>
          <v-flex xs12 md6 class="hidden-sm-and-down">
            <v-card flat class="transparent text-center">
              <v-card-title primary-title class="layout justify-center">
                <div class="headline">Glove</div>
              </v-card-title>
              <div class="headline grey--text text--darken-3 mb-4 text-center">Gloves</div>
              <p><em>たくましく、しなやかに<br>
          ...
          <v-flex xs12 md6 style="padding:0;">
            <v-parallax src="../assets/glove01.jpg" height="380">
              <v-layout column align-center justify-center class="hidden-md-and-up">
    ...
    <v-flex xs12>
      <v-container grid-list-xl fluid>
        <v-layout row wrap align-center>
          <v-flex xs12 md6 style="padding:0;">
            <v-parallax src="../assets/mitt02.jpg" height="380">
              <v-layout column align-center justify-center class="hidden-md-and-up">
                <div class="headline white--text mb-4 text-center"></div>Mitt
                <p><em>耐久性への挑戦<br>
                  操作性と耐久性を高い次元で求められるミットは芯材から選び抜き<br>
                  プロのブルペンキャッチャーからも信頼を得ています</em></p>
                <v-btn
                  class="mt-12"
                  color="grey lighten-5"
                  dark
